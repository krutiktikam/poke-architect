...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-32">
      ...
      {isAnalyzing && (
        <div className="fixed inset-0 bg-slate-900/20 backdrop-blur-[2px] z-[60] flex items-center justify-center">
          <div className="bg-white p-6 rounded-2xl shadow-xl flex flex-col items-center gap-4">
            <Loader2 className="w-10 h-10 text-indigo-600 animate-spin" />
            <p className="font-bold text-slate-700">Analyzing Team Dynamics...</p>
          </div>
        </div>
      )}
    </div>
